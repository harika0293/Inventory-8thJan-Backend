...
app.post("/api/ITRDrafts", (req, res) => {
  ...
  // const cardCode = req.body.list.cardCode;
  // const toWarehouse = req.body.list.toWarehouse;
  // const comments = req.body.list.comments;
  // const docDate = req.body.list.docDate;
  // const dueDate = req.body.list.dueDate;
  // const refDocEntry = req.body.list.docEntry;
  // const refObjType = req.body.list.objectType;
